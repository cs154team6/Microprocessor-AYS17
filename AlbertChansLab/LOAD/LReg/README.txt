...
All loading are expected to be called when the read head is pointing at Assembly Code sector.
...
(e.g. #LAB will make the read head point at 'a' after it's done)
